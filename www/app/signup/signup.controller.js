(function () {
    ...
    function signupController($state, tostService, googleLogin, $stateParams, facebookLogin, signupApi,
        ...
        //this function is used to load the states from server        
        ...
        self.createBusinessTypePopup = function () {
            ...
            var props = {
                'selectedPropertyName': 'selectedBusinessType',
                'controllerName': 'signup'
            }

            popupFactory.generatePopup('app/signup/partials/businessTypePopupTemplate.html', 'Business Type', $scope, props)
