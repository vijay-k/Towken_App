(function () {
    ...
    businessController.$inject = ['$state', '$rootScope', 'showCustomer', 'TotalCheckins', 'ApiError', 'tostService', 'tokenAdminFactory', 'CreateTowken', 'GetLatLng', 'GeoCoderFactory', '$window', 'geoService', '$scope', '$interval', '$ionicLoading', '$ionicModal', '$ionicPopover', 'localStorageService', 'customersService', 'Configurations'];
