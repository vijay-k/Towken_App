(function() {
    ...
    watchTowkenController.$inject = ['$stateParams', '$rootScope', 'showCustomer', 'tostService', 'tokenAdminFactory', 'CreateTowken', 'GetLatLng', 'GeoCoderFactory', '$window', 'geoService', '$scope', '$interval', '$ionicLoading', '$ionicModal', '$ionicPopover', 'localStorageService', 'customersService', 'Configurations'];
