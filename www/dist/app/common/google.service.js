(function() {
    'use strict';
    googleLogin.$inject = ['$http', '$q', '$interval', '$log', 'timeStorage', 'Configurations', '$ionicLoading'];
    angular.module('scale')
            .factory('googleLogin', googleLogin);
    function googleLogin($http, $q, $interval, $log, timeStorage,Configurations, $ionicLoading) {
        var service = {};
        service.access_token = false;
        service.redirect_url = Configurations.googleRedirecturl;
        service.client_id = Configurations.googleClientId;
        service.secret = Configurations.googleSecret;
        service.scope = Configurations.googleScope;
