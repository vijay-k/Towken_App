        (function() {
            ...
            profileController.$inject = ['$scope', '$ionicModal', '$rootScope', '$localStorage', 'showBusinessRating', 'showRedeemCode', '$state', 'ApiError', 'localStorageService', 'tostService', 'profileService', '$ionicLoading', 'UsedTowken'];
