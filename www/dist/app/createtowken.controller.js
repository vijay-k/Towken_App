(function () {
    ...
    CreateTowkenController.$inject = ['$state', '$stateParams', '$q', 'UpdateTowken', '$rootScope', '$cordovaCamera', 'ApiError', 'cameraService', '$ionicPopup', 'tostService', 'tokenAdminFactory', 'CreateTowken', 'GetLatLng', 'GeoCoderFactory', '$window', 'geoService', '$scope', '$interval', '$ionicLoading', '$ionicModal', '$ionicPopover', 'localStorageService', 'customersService', 'Configurations'];
