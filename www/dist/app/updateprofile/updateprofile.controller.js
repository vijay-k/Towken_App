    (function() {
        ...
        UpdateProfileController.$inject = ['$state', 'GetLatLng', 'BusinessLocation', 'ChekinFactory', 'SetChekinFactory', '$q', 'typeConversion', '$rootScope', 'tostService', 'geoService', 'ApiError', 'GeoCoderFactory', '$window', '$ionicLoading', '$ionicPopover', 'localStorageService', 'customersService', 'Configurations'];
