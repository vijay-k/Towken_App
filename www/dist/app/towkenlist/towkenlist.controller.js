(function() {
    ...
    towkenlistController.$inject = ['localStorageService', 'Configurations', 'ApiError', 'tostService', '$ionicPopover', '$ionicLoading', 'geoService', 'ShortType', 'ShortDiscount', 'ShortRating', 'ShortDistance', 'customersService', '$scope', '$state', 'typeConversion', '$rootScope'];
