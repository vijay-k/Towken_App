    (function() {
        ...
        customersController.$inject = ['$state', '$scope', 'ChekinFactory', 'SetChekinFactory', '$q', 'typeConversion', '$rootScope', 'tostService', 'geoService', 'ApiError', 'GeoCoderFactory', '$window', '$ionicLoading', '$ionicPopover', 'localStorageService', 'customersService', 'Configurations'];
