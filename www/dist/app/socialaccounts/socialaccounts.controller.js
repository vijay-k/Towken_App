(function() {
    'use strict';
    socialaccountsController.$inject = ['$state', '$ionicActionSheet', 'tostService', 'getSocialMediaAccount', '$ionicLoading', 'localStorageService', '$timeout', 'setSocialMediaAccount'];
    angular
        .module('scale')
