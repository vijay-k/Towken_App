    (function() {
        ...
        selectedtowkenlistController.$inject = ['$state', 'showComment', 'RateFactory', '$rootScope', '$ionicModal', '$scope', 'typeConversion', 'checkTowken', 'tostService', 'geoService', 'ApiError', '$window', 'GeoCoderFactory', '$ionicLoading', '$ionicPopover', 'localStorageService', 'customersService', 'Configurations'];
