(function () {
    ...
    CreateTowkenController.$inject = ['$state', '$stateParams', '$q',
        ...
        'localStorageService', 'customersService', 'Configurations'];
    ...
    function CreateTowkenController($state, $stateParams, $q, UpdateTowken, ApiError,
        ...
        $scope, $ionicLoading, $ionicModal, $ionicPopover, localStorageService, customersService, Configurations) {
        ...
        self.showDiscountCodePopup = function () {
            ...
            $ionicPopup.show({
                ...
                <md-input-container class="col font100">                     
                        <input type="text" class="text-uppercase letter-spacing-5" autofocus mdInput placeholder="Enter discount code"
