    (function() {
        ...
        thankyouController.$inject = ['$state', '$rootScope', 'typeConversion', '$cordovaSocialSharing', '$stateParams', 'tostService', 'geoService', 'ApiError', '$window', 'GeoCoderFactory', '$ionicLoading', '$ionicPopover', 'localStorageService', 'customersService', 'Configurations'];
